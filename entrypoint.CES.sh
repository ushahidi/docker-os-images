...
# Chained Entrypoint Scripts allows to easily compose multiple Dockerfile
...
# In order for entrypoints scripts to be chainable, they should finish their
